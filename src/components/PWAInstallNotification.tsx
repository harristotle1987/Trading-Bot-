      ...
      <AnimatePresence>
        {showAndroidPrompt && (
          <motion.div
            ...
            className="fixed top-1 right-2 sm:right-16 z-[9999] w-[260px] max-w-[92vw] bg-[#12161D] border border-[#3DDBD9] rounded-lg p-2 shadow-xl shadow-[#3DDBD9]/20 flex flex-col gap-1 relative overflow-hidden"
          >
            <div className="flex items-center justify-between gap-1.5">
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-6 rounded bg-gradient-to-br from-[#3DDBD9] to-[#0052FF] p-0.5 flex-shrink-0 shadow">
                  <img src="/icon-192.png" alt="Nexus Trade" className="w-full h-full object-cover rounded-[2px]" />
                </div>
                <div>
                  <h4 className="text-[10px] font-bold text-white leading-tight">Install Nexus Terminal</h4>
                </div>
              </div>
            ...
            <p className="text-[9px] text-gray-400 leading-tight">
              Fast mobile trading app with AI signals.
            </p>

            <div className="flex items-center gap-1 mt-0.5">
              <button
                onClick={handleInstallAndroid}
                className="flex-1 bg-[#3DDBD9] hover:bg-[#32C5C3] text-black font-extrabold text-[10px] py-1 px-2 rounded flex items-center justify-center gap-1 shadow-md active:scale-[0.98] transition-all"
              >
              ...
              <button
                onClick={handleDismissAndroidPrompt}
                className="px-2 py-1 rounded border border-[#232833] bg-[#181D26] hover:bg-[#232833] text-gray-400 hover:text-white text-[10px] font-medium transition-colors"
              >
                Close
              </button>
            </div>
